  ...
  return (
    <div className="bg-main">
      <div className="bg-light p-5 rounded shadow-sm">
        ...
        <Link className="an-account">Already have an account</Link>
        <div className="d-flex align-items-center">
          <div className="or-div"></div>
          <p className="mx-2 text-secondary">or</p>
          <div className=" or-div"></div>
        </div>
        <div class="flex items-center space-x-3 justify-center border border-gray-300 rounded-lg w-full py-3 cursor-pointer hover:bg-gray-100">
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
	...
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
          ...
          <span class="poppins">Sign Up With Google</span>
        </div>
      </div>
    </div>
  );
